...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_TRAN_PROJECT CUSTOM_TRAN_BOM CUSTOM_HAL_LENS BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS MTK_MODEM_SUPPORT CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_TX_AUDIO MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
# modified XWWYSHSJW-4 for lcm driver by cheng.wang 2018-01-11 start
BOOT_LOGO = hdplus
# modified XWWYSHSJW-4 for lcm driver by cheng.wang 2018-01-11 end
#add XWWYSHSJW-1 by suwen.huang 20180118 start
TRAN_TP_SUPPORT = yes
#add XWWYSHSJW-1 by suwen.huang 20180118 end
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_MTK_SDK =
BUILD_PRELOADER = yes
BUILD_UBOOT = no
# Add HLSSPUB-6913 by chencheng 20180117 start
CUSTOM_BUILD_VERNO = CY-X5514D-H395
# Add HLSSPUB-6913 by chencheng 20180117 end
# Modified XWWYSHSJW-125 by cheng.wang 20180223 start
CUSTOM_CONFIG_MAX_DRAM_SIZE = 0xC0000000
# Modified XWWYSHSJW-125 by cheng.wang 20180223 end
CUSTOM_HAL_ANT = mt6739_ant_m1
CUSTOM_HAL_AUDIOFLINGER = audio
CUSTOM_HAL_BLUETOOTH = bluetooth
CUSTOM_HAL_CAMERA = camera
#modify XWWYSHSJW-11 by quan.chang 180126 start
CUSTOM_HAL_CAM_CAL = s5k3l8_eeprom
#modify XWWYSHSJW-11 by quan.chang 180126 end
CUSTOM_HAL_COMBO = mt6739
CUSTOM_HAL_EEPROM = dummy_eeprom
#modify XWWYSHSJW-11 by quan.chang 180116 start
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_mipi_raw_sunwin gc5034_mipi_raw gc2905_mipi_raw gc8034_mipi_raw
CUSTOM_HAL_LENS = dw9718saf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = gc2905_mipi_raw
TRAN_CAMERA_FRONT_FLASHLIGHT_LEVEL_SUPPORT=yes
#modify XWWYSHSJW-11 by quan.chang 180116 end
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
#modify XWWYSHSJW-11 by quan.chang 180116 start
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_mipi_raw_sunwin
...
#modify XWWYSHSJW-11 by quan.chang 180116 start
CUSTOM_HAL_SUB_IMGSENSOR = gc5034_mipi_raw gc8034_mipi_raw
#modify XWWYSHSJW-11 by quan.chang 180116 end
...
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-11 start
CUSTOM_KERNEL_BAROMETER = no
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-11 end
...
#modify XWWYSHSJW-11 by quan.chang 180116 start
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_mipi_raw_sunwin gc5034_mipi_raw gc2905_mipi_raw gc8034_mipi_raw
#modify XWWYSHSJW-11 by quan.chang 180116 end
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
#modify XWWYSHSJW-11 by quan.chang 180116 start
CUSTOM_KERNEL_LENS = dw9718saf dummy_lens
#modify XWWYSHSJW-11 by quan.chang 180116 end
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
#modify XWWYSHSJW-56 by quan.chang 180226 start
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc2905_mipi_raw
#modify XWWYSHSJW-56 by quan.chang 180226 end
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714af
#modify XWWYSHSJW-11 by quan.chang 180116 start
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_mipi_raw_sunwin
...
#modify XWWYSHSJW-11 by quan.chang 180116 start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc5034_mipi_raw gc8034_mipi_raw
#modify XWWYSHSJW-11 by quan.chang 180116 end
...
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-16 start
MICROTRUST_TEE_SUPPORT = yes
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-16 end
MNTL_SUPPORT = no
...
#Infinix: modify  by sangui.zhang TRPM-926 20180105 start
MTK_BUILD_VERNO = X5514-H395AD-O-181207V217
FINGERPRINT_BUILD_VERNO = AD-181207V217
#Infinix: modify  by sangui.zhang TRPM-926 20180105 end
MTK_BWC_SUPPORT = yes
# modif XWWYSHSJW-2 by muduo.qin 20180109 start
MTK_C2K_LTE_MODE = 0
# modif XWWYSHSJW-2 by muduo.qin 20180109 end
...
#modify XOSOREL-5035 by yinwei.sun 180314 start
MTK_CAM_IMAGE_REFOCUS_SUPPORT = yes
#modify XOSOREL-5035 by yinwei.sun 180314 end
...
# modify XWWYSHSJW-5 by yangyong 20180115 start
MTK_FACTORY_MODE_IN_GB2312 = no
# modify XWWYSHSJW-5 by yangyong 20180115 end
...
MTK_FIRST_MD = 1
#modified XWWYSHSJW-2194 by renyanzhen 20180416 start
...
MTK_IRTX_SUPPORT = no
#modify XWWYSHSJW-6 by xiaoyu.wang 20180307 start
MTK_JEITA_STANDARD_SUPPORT = yes
TRAN_CHARGER_COULOMB_SUPPORT = yes
#modify XWWYSHSJW-6 by xiaoyu.wang 20180307 end
...
#infinix:open MTK LOG start XWWYSHSJW-23
MTK_LOG_CUSTOMER_SUPPORT = yes
#infinix:open MTK LOG end XWWYSHSJW-23
...
#Infinix:fangjianxiong modify for Volte 20180307 start
MTK_MD_SBP_CUSTOM_VALUE = 0
#Infinix:fangjianxiong modify for Volte 20180307 end
...
#modify FELTEHSJS-468 by jinbao 20180316 start
MTK_PERMISSION_CONTROL = no
#modify FELTEHSJS-468 by jinbao 20180316 end
#add XWWYSHSJW-3 by wurui.zhang 2018-01-17 start 
MTK_PERSIST_PARTITION_SUPPORT = yes
#add XWWYSHSJW-3 by wurui.zhang 2018-01-17 end
...
#modified XWWYSHSJW-2745 by renyanzhen 20180608 start
MTK_PROTOCOL1_RAT_CONFIG = Lf/Lt/W/G
MTK_PROTOCOL2_RAT_CONFIG = L/W/G
#modified XWWYSHSJW-2745 by renyanzhen 20180608 end
...
#PPD:add syncHeartBeat switch by yangjian 20180205 start
TRAN_SYNC_GROUP_SUPPORT = yes
#PPD:add syncHeartBeat switch by yangjian 20180205 end
...
#infinix:modify by sangi.zhang XWWYSHSJW-23 start 
MTK_RUNNING_BOOSTER_SUPPORT = no
#infinix:modify by sangi.zhang XWWYSHSJW-23 end
...
#infinix:modify by sangi.zhang XWWYSHSJW-23 start 20180123
MTK_SIGNATURE_CUSTOMIZATION = yes
#infinix:modify by sangi.zhang XWWYSHSJW-23 end 20180123
MTK_SIGNMODEM_SUPPORT = no
MTK_SIM1_SOCKET_TYPE = 1
MTK_SIM2_SOCKET_TYPE = 1
MTK_SIM_HOT_SWAP = yes
#modified XWWYSHSJW-8 by renyanzhen 20180117 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
#modified XWWYSHSJW-8 by renyanzhen 20180117 end
...
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-13 start
MTK_TEE_SUPPORT = yes
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-13 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#add XWWYSHSJW-6 by xiaoyu.wang 20180226 start
MTK_UART_USB_SWITCH = yes
#add XWWYSHSJW-6 by xiaoyu.wang 20180226 end
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#modified XWWYSHSJW-2194 by renyanzhen 20180416 end
...
# modify by wenyan.yu for XWWYSHSJW-1214 20180313 start
MTK_WMA_PLAYBACK_SUPPORT = no
# modify by wenyan.yu for XWWYSHSJW-1214 20180313 end
...
#PPD add RBHSQYB-3915 by zeyang.li 20180131 start
TRAN_PNPMGR_SUPPORT = yes
#PPD add RBHSQYB-3915 by zeyang.li 20180131 end
#add XWWYSHSJW-1 by chencheng3 20180112 start
CUSTOM_TRAN_PROJECT= tran_x5514d
CUSTOM_TRAN_BOM= tran_x5514d_d1
#add XWWYSHSJW-1 by chencheg3 20180112 end
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-13 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee
TRAN_AUDIOTEST_SUPPORT = yes
#modify XWWYSHSJW-3 by wurui.zhang 2018-01-13 end
#add XWWYSHSJW-5 by yangyong 20180115 start
TRAN_FT_CUSTOM_PERMISSION_SUPPORT = yes
#add XWWYSHSJW-5 by yangyong 20180115 end
...
#add by yangyong for meta executing shell command 20180115 start
TRAN_FT_CUSTOM_SHELL = yes
#add by yangyong for meta executing shell command 20180115 end

#add by yangyong  sim-sd tray detect  20180115 start
TRAN_FT_SIM_SD_TRAY_DETECT = yes
#add by yangyong  sim-sd tray detect  20180115 end

#add XWWYSHSJW-5 by yangyong for benchflag 20180115 start
TRAN_FT_BENCHFLAG_SUPPORT = yes
TRAN_PHONELOCK_SUPPORT = yes
#add XWWYSHSJW-5 by yangyong for benchflag 20180115 end
#add XWWYSHSJW-5 by yangyong 20180119 secboot start
TRAN_SEC_FILE_COPY_SUPPORT=yes
#add XWWYSHSJW-5 by yangyong 20180119 secboot end
#Infinx:add by caizhaohui for midtest start
TRAN_INFINIX_MIDTEST_SUPPORTED = yes
RLK_MIDTEST_SUPPORT = yes
MIDTEST_COMPASS_SUPPORTED = yes
MIDTEST_FLASH_FORWARD_SUPPORTED = yes
MIDTEST_DUAL_MIC_SUPPORTED = yes
MIDTEST_DISTANCE_SENSOR_SUPPORTED = yes
MIDTEST_LIGHT_SENSOR_SUPPORTED = yes
MIDTEST_FINGERPRINTF_SUPPORTED = yes
MIDTEST_FINGER_SW_TEE_SUPPORTED = yes
MIDTEST_DUAL_CAMERA_SUPPORTED = yes
#Infinx:add by caizhaohui for midtest end
#infinix:add by sangui.zhang for gallery start
OPR_COMMON_GALLERY_SUPPORT = yes
#infinix:add by sangui.zhang for gallery end
#infinix:add by sangui.zhang for XWWYSHSJW-23 start
TRAN_OS_TYPE = XOS
TRAN_OS_LITE = yes
BUILD_GMS = yes
TRAN_OS_SUPERSCREEN_SUPPORT = yes
#infinix:add by sangui.zhang for XWWYSHSJW-23 end

#[PPD] add for FELTEHSJS-93 by hanhao 20180205 start
TRAN_PROCMGR_SUPPORT=yes
TRAN_PROCMGR_MODE=deep
TRAN_LMK_BOOST_SUPPORT=yes
#[PPD] add for FELTEHSJS-93 by hanhao 20180205 end
#PPD: add XWWYSHJW-701 by ruishuang.jia for LUCID 18/03/13 start
TRAN_PPD_LUCID_DISABLED = no
#PPD: add XWWYSHJW-701 by ruishuang.jia for LUCID 18/03/13 end

#add XWWYSHSJW-36 by cheng.wang for brightness permission 20180131 start
TRAN_LCM_SUPPORT = yes
#add XWWYSHSJW-36 by cheng.wang for brightness permission 20180131 end
#infinix:modify by sangi.zhang XWWYSHSJW-23 start 20180123
TRAN_ADAPT_COMMON_CONFIG = yes
#infinix:modify by sangi.zhang XWWYSHSJW-23 end 20180123
#infinix:add by jinbaoping for 20180201 start
RLK_PROJECT = infinix_x5514
RLK_RLKSETTINGS_SUPPORT = yes
#infinix:add by jinbaoping for 20180201 end
#infinix:add by sangui.zhang for XWWYSHSJW-23 start
#INFINIX_RSA_LEVEL = level1
TRAN_GMS_O = yes
TRAN_BRAND_CONFIG = Infinix
TRAN_ADAPT_COMMON_CONFIG_BUILDINFO = yes
#infinix:add by sangui.zhang for XWWYSHSJW-23 end
#modify RALHSJS-37 by jinbao 20180203 start
#google revenue share(RSA) config:
TRAN_RSA_BRAND=infinix
TRAN_RSA_LEVEL=rev1
#modify RALHSJS-37 by jinbao 20180203 end
#infinix:add by sangui.zhang for XWWYSHSJW-23 thirdpart start
TRAN_PHOENIXB_BROWSER_SUPPORTED = yes
#TRAN_DUALAID_SUPPORTED = yes
TRAN_XCLUB_SUPPORTED = yes
TRAN_FACEBOOK_FULL_SUPPORTED = yes
TRAN_WHATSAPP_SUPPORT = yes
TRAN_CARLCARE_SUPPORT = yes
TRAN_KIKA_FULL_SUPPORTED = yes
TRAN_TOUCHPALS_SUPPORTED = yes
TRAN_TOUCHPALS_ZAWGYIPACK_SUPPORTED = yes
#infinix:add by sangui.zhang for XWWYSHSJW-23 thirdpart end

#[PPD] add vm param by peng.zhang 20180208 start
TRAN_VM_STARTSIZE = 12m
TRAN_VM_MAXFREE_SIZE = 8m
TRAN_VM_MINFREE_SIZE = 3m
#[PPD] add vm param by peng.zhang 20180208 end

#[PPD]add XWWYSHSJW-67 by xingxing.wang on 20180206 start
TRAN_USE_F2FS = yes
#[PPD]add XWWYSHSJW-67 by xingxing.wang on 20180206 end
...
#Add XWWYSHSJW-53 by ningtao.ma 20180206 start
TRAN_CAMERA_FEATURE_V2 = yes
TRAN_CAMERA_ARCSOFT_DENOISE = yes
TRAN_CAMERA_ARCSOFT_LOWLIGHT = yes
TRAN_CAMERA_FRONT_MIRROR = yes
TRAN_CAMERA_USE_PERFSERVICE = yes
TRAN_CAMERA_PICSELFIE_BEAUTY = yes
TRAN_CAMERA_ARCSOFT_BEAUTY = yes
TRAN_CAMERA_AUTO_LOGO = yes
#Add XWWYSHSJW-53 by ningtao.ma 20180206 end
#PPD: add skip wakelock by xionghui 20171211 start
TRAN_REMOVE_WAKELOCK_SUPPORT = yes
#PPD: add skip wakelock by xionghui 20171211 end
#PPD: add sleepmaster by xionghui 20171211 start
TRAN_SLEEPMASTER_SUPPORT = yes
#PPD: add sleepmaster by xionghui 20171211 end
#infinix:add by jinbaoping for XWWYSHSJW-83 thirdpart start
RLK_INFINIX_AGINGFUNCTION = yes
RLK_INFINIX_AGINGTEST = yes
TRAN_INFINIX_INTE_PROJECT_EXCLUSION = yes
#infinix:add by jinbaoping for XWWYSHSJW-83 thirdpart end

#[PPD]: XWWYSHSJW-84 modify memory para by shaojun.zou 20180207 start
TRAN_MEMORY_2G_SUPPORT = yes
#[PPD]: XWWYSHSJW-84 modify memory para by shaojun.zou 20180207 end
#Infinix：X5515-H398 Delete UserGuide haojie.liu 20180424 start
#add by haojie.liu for UserGuide 20171129 start
#RLK_USERGUIDE_OPEN=yes
#RLK_USERGUIDE_VERSION=x5514_h395_a1_o
#add by haojie.liu for UserGuide 20171129 end
#Infinix：X5515-H398 Delete UserGuide haojie.liu 20180424 end
#infinix:add by sangui.zhang for GBOARD start
TRAN_GBOARD_SUPPORT = yes
#infinix:add by sangui.zhang for GBOARD end
#infinix:add XWWYSHSJW-214 xiangqiu.meng start 20180226
RLK_COMPASS_SUPPORT=yes
#infinix:add XWWYSHSJW-214 xiangqiu.meng end 20180226
#add lijia.chen 2018-02-24 start
OS_NOTEBOOK_SUPPORT = yes
OS_VIDEO_SUPPORT = yes
OS_XSHARE_SUPPORT = yes
OS_XHIDE_SUPPORT = yes
TRAN_DISABLE_ADB_RSA_SUPPORT = no
OS_CLOUD_SUPPORT = no
TRAN_EALGEEE_SUPPORTED = yes
TRANSSION_XMALL_SUPPORT = yes
MAGAZINE_SERVICE_SUPPORT = yes
TRAN_CARLCARE_UNINSTALL_SUPPORT = yes
OS_FINGERPRINT_SUPPORT = yes
TRAN_EAGLEEE_UNINSTALL_SUPPORT = yes
TRAN_SPORTYBET_SUPPORT = yes
PHONE_LOCK_START_SUPPORT = yes
TRAN_DEX_PREOPT_SUPPORT = yes
TRAN_XFEEDBACK_SUPPORT = yes
#TRAN_CHROME_HOMEPAGE_BOOKMARK_SUPPORT = yes
TRAN_PAI_SUPPORT = yes
TRAN_FOOVIEW_SUPPORT = yes
TRAN_VISHA_SUPPORT = yes
TRAN_BOOMPLAY_GO_UNINSTALL_AVAILABLE_SUPPORT = yes
#add lijia.chen 2018-02-24 end

#add XWWYSHSJW-66 by wurui.zhang 2018-02-25 start
TRAN_VIRTUAL_GYROSCOPE_ALGORITHM=yes
#add XWWYSHSJW-66 by wurui.zhang 2018-02-25 end

#Infinix:modify XWWYSHSJW-166 by quanhaisong 20180227 start
OS_SETTINGS_LITE_CUSTOM = no
#Infinix:modify XWWYSHSJW-166 by quanhaisong 20180227 end
...
#Infinix:add by haojie.liu for Wallpaper 20180305 start
TRAN_WALLPAPER_OPEN=yes
OS_WALLPAPER_OPEN=no
#Infinix:add by haojie.liu for Wallpaper 20180305 end


#Camera3.0 add start
ARCSOFT_BURST_SUPPORT = yes
VISIDON_ASD_SUPPORT = no
RLK_PORTRAIT_MODE_SUPPORT = yes
...
RLK_CAMERA_QUICKCAPTURE = yes
RLK_AUX_MODE_UNSUPPORT = yes
#end

#Infinix: add for XWWYSHSJW-804 by liunian 20180306 start
TRAN_RESET_SYS_SETTINGS_SUPPORT = yes
#Infinix: add for XWWYSHSJW-804 by liunian 20180306 end
#infinix:add jinbaoping
RLK_RLKSETTINGS_SUPPORT_INFINIX = yes
#infinix:add jinbaoping

#Infinix：add by lijia.chen for XWWYWHSJB-58 start
OS_MULTI_WINDOW_SUPPORT = yes
#Infinix：add by lijia.chen for XWWYWHSJB-58 end

#Infinix: Add by fuyu 20180404 start
CUSTOM_DEVIE_INFO_SUPPORT = yes
#Infinix: Add by fuyu 20180404 end

#infinix:add by hanbingwei for XWWYSHSJW-1487 20180419 start
SUPPORT_DIALER_PERMANENT = yes
#infinix:add by hanbingwei for XWWYSHSJW-1487 20180419 end
#infinix:add by lilonglong for XWWYSHSJW-2357 20180427 start
#TRAN_BOOMPLAY_SUPPORT = yes
#RLK_PALMPLAY_SUPPORTED = yes
RLK_PALMCHAT_SUPPORTED = yes
#MTK_SOUNDRECORDER_APP = yes
#infinix:add by lilonglong for XWWYSHSJW-2357 20180427 end

#Infinix:Added by LIKai2 for XWWYWHSJB-1303 20180502 start
OS_DOCUMENTSUI_LITE_CUSTOM = no
#Infinix:Added by LIKai2 for XWWYWHSJB-1303 20180502 end

#TSD: modify for XWWYSHSJW-2810 by chen.chen 20180628 start
TRAN_OOBE_ENABLE_DATA=yes
#TSD: modify for XWWYSHSJW-2810 by chen.chen 20180628 end